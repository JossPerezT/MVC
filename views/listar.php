        ...
        <?php } else {
          ...
          foreach ($mostrarClientes["id_cliente"] as $i => $cliente) { ?>
            <tr>
              ...
              <td>
                <?= $mostrarClientes["fecha_registro"][$i] ?>
              </td>
              ...
              <td>
                ...
                <i class="bi bi-x-circle cancelar cancelar-<?= $cliente ?>" data-idcliente="<?= $cliente ?>"
                  data-nombre="<?= $mostrarClientes["nombre"][$i] ?>" data-email="<?= $mostrarClientes["email"][$i] ?>"
                  data-telefono="<?= $mostrarClientes["telefono"][$i] ?>"
                  data-direccion="<?= $mostrarClientes["direccion"][$i] ?>" data-rfc="<?= $mostrarClientes["rfc"][$i] ?>"
